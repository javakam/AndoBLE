...
public class DeviceListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, final int i) {
        ...
        final BluetoothDevice bluetoothDevice = mBluetoothDeviceList.get(i);
        final String rssi = mRssiList.get(i);

        deviceListViewHolder.tvName.setText(bluetoothDevice.getName());
        deviceListViewHolder.tvMac.setText(bluetoothDevice.getAddress());
        deviceListViewHolder.tvRssi.setText(String.format("Rssi = %s", rssi));
